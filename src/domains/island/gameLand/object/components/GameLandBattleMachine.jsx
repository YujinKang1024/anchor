...
import { isEnterIslandAtom, isOnBattleAtom } from '@/domains/island/atoms/playerStateAtoms';
import { isLandMenuOpenAtom } from '@/atoms';

import gameBattleMachine from '@/assets/models/gameLand-battleMachine.glb';

export const GameLandBattleMachine = forwardRef(({ onClick, onPointerOut, onPointerOver }, ref) => {
